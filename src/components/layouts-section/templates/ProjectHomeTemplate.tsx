  ...
  return (
    <div data-el="template-project-home" className="overflow-y-auto h-[500px] rounded-lg border border-white/10" style={{ backgroundColor: 'var(--bg-page)' }}>
      ...
      <section className="px-8 py-12 text-center">
        ...
        <p className="text-sm mb-6 max-w-[420px] mx-auto" style={{ color: 'var(--text-muted)' }}>A minimalist design foundation that speaks two languages and adapts to any digital vision.</p>
