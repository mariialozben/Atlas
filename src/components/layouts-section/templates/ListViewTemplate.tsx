...
export default function ListViewTemplate() {
  return (
    <div data-el="template-list-view" className="overflow-y-auto h-[500px] rounded-lg border border-white/10" style={{ backgroundColor: 'var(--bg-page)' }}>
      <div className="px-6 py-4 border-b border-white/10 flex items-center gap-3">
        <Input placeholder="Search..." className="max-w-[200px] h-8 text-xs" />
        <Button variant="secondary" size="sm">Filter</Button>
        <span className="ml-auto text-xs" style={{ color: 'var(--text-muted)' }}>6 items</span>
      </div>
      ...
      <div className="px-6 py-3 border-t border-white/10 flex items-center justify-between">
        <span className="text-xs" style={{ color: 'var(--text-muted)' }}>Page 1 of 1</span>
