...
export default function ModalDetailTemplate() {
  return (
    <div data-el="template-modal-detail" className="h-[500px] rounded-lg border border-white/10 flex items-center justify-center" style={{ backgroundColor: 'var(--gray-900)' }}>
      <div className="text-center space-y-4">
        <p className="text-sm" style={{ color: 'var(--gray-400)' }}>Modal / Detail view — triggered over any base layout</p>
        <Dialog>
